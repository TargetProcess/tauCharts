define(function (require) {
    ...
    describe('utils-draw', function() {
        ...
        it('should interpolate path points', function() {
            ...
            var interpolator1 = drawUtils.createPointsInterpolator(a, b);
            ...
            var interpolator2 = drawUtils.createPointsInterpolator(b, a);
            ...
            var interpolator3 = drawUtils.createPointsInterpolator([], b);
            ...
            var interpolator4 = drawUtils.createPointsInterpolator(b, []);
            ...
            var interpolator5 = drawUtils.createPointsInterpolator(a.slice(0, 3), [a[0]]);
            ...
            var interpolator6 = drawUtils.createPointsInterpolator(a.slice(0, 3), [a[0], a[2]]);
            ...
            var interpolator7 = drawUtils.createPointsInterpolator([a[0], a[2]], a.slice(0, 3));
            ...
            var interpolator8 = drawUtils.createPointsInterpolator([a[0], {id: 7, x: 10, y: 40}, a[2]], a.slice(0, 3));
