                ...
                value: function _parseExpression(expr, parentPipe) {
                    ...
                    var dataFn = bInherit ? function () {
                        return parentPipe.reduce(function (data, cfg) {
                            return _this.trans[cfg.type](data, cfg.args);
                        }, src.data);
                    } : function () {
                        return src.data;
                    };
...
define('plugins',["exports"], function (exports) {
    ...
    var propagateDatumEvents = function propagateDatumEvents(chart) {
        return function () {
