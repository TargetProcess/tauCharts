    ...
    var $$unit$visitor$factory$$TUnitVisitorFactory = (function () {
        ...
        var TUnitMap = {
            ...
            'COORDS/RECT': function (unit, srcData, continueTraverse) {
                ...
                var matrixOfPrFilters = new $$matrix$$TMatrix(unitFunc(srcData, x.scaleDim, y.scaleDim));
    ...
    $$dsl$reader$$DSLReader.prototype = {
        traverse: function (rawData) {
            ...
            var buildLogicalGraphRecursively = function (unitRef, srcData) {
                return $$unit$visitor$factory$$TUnitVisitorFactory(unitRef.type)(unitRef, srcData, buildLogicalGraphRecursively);
            };
