(function(definition) {
    ...
    var utils$$class2type = ["Boolean", "Number", "String", "Function", "Array", "Date", "RegExp", "Object", "Error"].reduce(function (class2type, name) {
        class2type["[object " + name + "]"] = name.toLowerCase();
        return class2type;
    }, {});
    var utils$$toString = {}.toString;
    ...
    var utils$$utils = {
        ...
        type: function(obj)  {
            ...
            utils$$class2type[utils$$toString.call(obj)] || "object" :
                typeof obj;
        },
    ...
    var node$visitor$factory$$TNodeVisitorFactory = (function () {
        ...
        var TNodeMap = {
            ...
            'ELEMENT.POINT': function (node) {
                ...
                colorDim = colorParam;
                if (utils$$utils.type(colorParam) === 'string') {
                    range = defaultRange;
                    domain = getDefaultDomain();
                } else if (utils$$utils.isArray(colorParam.brewer)) {
    ...
    var unit$domain$mixin$$UnitDomainMixin = (function(){"use strict";var PRS$0 = (function(o,t){o["__proto__"]={"a":t};return o["a"]===t})({},{});var DP$0 = Object.defineProperty;var GOPD$0 = Object.getOwnPropertyDescriptor;var MIXIN$0 = function(t,s){for(var p in s){if(s.hasOwnProperty(p)){DP$0(t,p,GOPD$0(s,p));}}return t};var proto$0={};
        ...
        function UnitDomainMixin(meta, data) {var this$0 = this;
            ...
            this.fnScaleTo = function(scaleDim, interval)  {
                ...
                return unit$domain$mixin$$rangeMethods[dimx.scaleType](this$0.fnDomain(dimx.scaleDim, dimx.name), interval);
            };
