...
SpecEngineTypeMap['AUTO-NO-OPTIMIZATION'] = (srcSpec, meta, settings) => {
...
SpecEngineTypeMap.AUTO = (srcSpec, meta, settings) => {
    return ['BUILD-LABELS', 'BUILD-GUIDE', 'OPTIMAL-SIZE'].reduce(
        (spec, engineName) => SpecEngineTypeMap[engineName](spec, meta, settings),
        srcSpec
    );
};

SpecEngineTypeMap['COMPACT-NO-OPTIMIZATION'] = (srcSpec, meta, settings) => {
...
SpecEngineTypeMap.COMPACT = (srcSpec, meta, settings) => {
    return ['BUILD-LABELS', 'BUILD-COMPACT', 'OPTIMAL-SIZE'].reduce(
        (spec, engineName) => SpecEngineTypeMap[engineName](spec, meta, settings),
        srcSpec
    );
};
