import FieldsTemplate, {TOOLTIP_CLS} from '../tooltip/fields-template';
...
export default class DiffTemplate extends FieldsTemplate {
    ...
    filterFields(fields) {
        const unit = this.tooltip.state.highlight.unit as GrammarElement;
        ...
        return super.filterFields(filtered);
    }
    ...
    didMount() {
        ...
        const node = this.tooltip.getDomNode() as HTMLElement;
